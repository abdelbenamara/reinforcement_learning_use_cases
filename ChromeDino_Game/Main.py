...
logger.info(f'Program launched. Data: Number of genes: {numGenes}, '
            f'Mutation probability: {mutationProb}, Selected genes: {selection}')
logger.info(f'Mode has been chosen {mode}')
